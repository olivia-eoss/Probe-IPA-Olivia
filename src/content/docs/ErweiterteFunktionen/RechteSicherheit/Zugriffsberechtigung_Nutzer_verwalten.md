...
1. Wähle im Feld **Access** die Art des Zugriffs aus, z.B. _Read_, _Write_, _Export_ oder _Report_.
1. Wähle im Feld **Typ** die Art des Nutzers aus, z.B. einen einzelnen _[Nutzer](Nutzer_anlegen)_ oder eine _[Nutzergruppe](Nutzergruppe_erstellen)_.
...
<kbd>![GIF: Nutzer Datenzugriff gewähren](assets/Zugriffsberechtigung_Nutzer_verwalten.gif)</kbd>
