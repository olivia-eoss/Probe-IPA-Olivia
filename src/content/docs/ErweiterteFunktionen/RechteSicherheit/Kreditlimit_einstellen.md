...
1. Wähle eine **Kreditlimit Art** aus, z.B. _Management_.
...
1. Stelle ein **Datum von** ein.
   ...
   > **Hinweis:** Liegt das Datum in der _Vergangenheit_, ist das Kreditlimit _ab sofort_ gültig. Liegt es in der _Zukunft_, gilt es _erst ab diesem Datum_.
...
<kbd>![GIF: Kreditlimit](assets/Kreditlimit_einstellen.gif)</kbd>
