...
Manche Einträge können auch anhand von "Aktiv"-Status gefiltert werden, d.h. ob eine Eigenschaft aktiv oder inaktiv ist. Beispielsweise kannst Du im Fenster "[Anrufliste](Anrufplanung_Anrufe_filtern)" die Einträge nach erteilten und **_nicht_** erteilten Aufträgen sowie nach getätigten und **_nicht_** getätigten Anrufen filtern.
...
| Klicke ein zweites Mal darauf, um nach Einträgen zu suchen, bei denen diese Eigenschaft **_nicht_** aktiviert ist.                    |                  ![](assets/Checkbox_activated_empty.png)                  |
...
<kbd>![GIF: Filterfunktion](assets/Filtering function.gif)</kbd>
