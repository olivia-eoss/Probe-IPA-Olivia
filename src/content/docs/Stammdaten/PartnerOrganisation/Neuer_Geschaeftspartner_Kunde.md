...
1. **_Optional:_** Füge weitere Bedingungen hinzu, wie z.B. **Zahlungsweise**, **Zahlungsbedingung**, [**Mahnung**](Einrichtung_Mahnung) usw.
1. Klicke auf "Bestätigen", um die Änderungen zu übernehmen und die "Erweiterte Erfassung" zu schließen.

## Beispiel

<kbd>![GIF: Wie erfasse ich einen neuen Kunden?](assets/Neuer_Geschaeftspartner_Kunde.gif)</kbd>
