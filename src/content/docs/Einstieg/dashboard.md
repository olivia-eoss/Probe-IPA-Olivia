...
- Wähle aus dem Auswahlfenster ein Widget durch anklicken aus und ziehe es per _Drag and Drop_ ![](assets/Cursor_MoveWidget_YES.png) an die gewünschte Stelle auf dem Dashboard.
...
- Wähle auf dem Dashboard ein Widget durch anklicken aus und ziehe es per _Drag and Drop_ an eine andere Stelle auf dem Dashboard.
