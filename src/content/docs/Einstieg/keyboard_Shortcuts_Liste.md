...
<kbd>![GIF: Dynamische Dropdown-Liste](assets/Dynamische_Dropdown-Liste.gif)</kbd>
...
|           `Alt` + `Z`            |         `⌥ alt` + `Z`          | _Nur in Aufträgen:_<br> Overlay-Fenster für Produktvorschläge öffnen |
...
<kbd>![GIF: Einzüge ein-/ausklappen und selektieren](assets/Listenansicht_aus-einklappen_selektieren.gif)</kbd>
